...
import { HttpMethodType, ParameterType, RouteMetadata } from '@core/base';
import type { ApiResponse, SwaggerConfig } from '../../types';
...
export class SwaggerDocument {
  ...
  private getPath(route: RouteMetadata) {
    ...
    const tag = route.controller.name;
